      ...
      >
        ...
        <div className="w-full flex sm:flex-row flex-col justify-start items-start space-y-4 sm:space-y-0 sm:space-x-4">
          ...
          <button
            ...
            className="px-2 hover:text-gray-800 text-sm leading-4 text-gray-500 flex justify-center items-center space-x-2 py-4 w-full rounded-lg border border-gray-500"
          >
            <svg
              width="20"
              height="20"
        ...
        <div className="flex justify-start items-start space-x-2">
          ...
          <p className="text-gray-500 text-xs leading-3">
            I agree to <span className="text-gray-800">Terms of Service</span> &
